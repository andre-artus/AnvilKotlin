...
open class DSLImageView : BaseDSL() {
	...
	open fun alpha(arg: Int) = trikita.anvil.DSL.alpha(arg)
...
open class DSLWebView : DSLAbsoluteLayout() {
	open fun certificate(arg: SslCertificate) = trikita.anvil.DSL.certificate(arg)
	...
	open fun mapTrackballToArrowKeys(arg: Boolean) = trikita.anvil.DSL.mapTrackballToArrowKeys(arg)
