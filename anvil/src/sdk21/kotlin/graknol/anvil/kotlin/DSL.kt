...
object DSLActionMenuView : DSLActionMenuViewBase<ActionMenuView.LayoutParams>()
...
object DSLToolbar : DSLToolbarBase<Toolbar.LayoutParams>()
object DSLTvView : DSLTvViewBase<ViewGroup.LayoutParams>()
...
abstract class DSLActionMenuViewBase<T : ActionMenuView.LayoutParams> : DSLLinearLayoutBase<T>() {
...
abstract class DSLToolbarBase<T : Toolbar.LayoutParams> : DSLViewGroupBase<T>() {
...
abstract class DSLTvViewBase<T : ViewGroup.LayoutParams> : DSLViewGroupBase<T>() {
