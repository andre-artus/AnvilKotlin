...
inline fun Anvil.Renderable.mediaRouteButton(crossinline r: DSLMediaRouteButton.() -> Unit): DSLResultStub {
	var result: DSLResultStub? = null
	DSL.mediaRouteButton {
		DSLMediaRouteButton.r()
		result = DSLResultStub.fromCurrentView()
	}
	return result!!
}

inline fun Anvil.Renderable.tvView(crossinline r: DSLTvView.() -> Unit): DSLResultStub {
	var result: DSLResultStub? = null
	DSL.tvView {
		DSLTvView.r()
		result = DSLResultStub.fromCurrentView()
...
inline fun Anvil.Renderable.toolbar(crossinline r: DSLToolbar.() -> Unit): DSLResultStub {
	var result: DSLResultStub? = null
	DSL.toolbar {
		DSLToolbar.r()
		result = DSLResultStub.fromCurrentView()
...
inline fun Anvil.Renderable.actionMenuView(crossinline r: DSLActionMenuView.() -> Unit): DSLResultStub {
	var result: DSLResultStub? = null
	DSL.actionMenuView {
		DSLActionMenuView.r()
		result = DSLResultStub.fromCurrentView()
...
inline fun Anvil.Renderable.textClock(crossinline r: DSLTextClock.() -> Unit): DSLResultStub {
	var result: DSLResultStub? = null
	DSL.textClock {
		DSLTextClock.r()
		result = DSLResultStub.fromCurrentView()
...
object DSLActionMenuView : DSLActionMenuViewBase() {
...
abstract class DSLActionMenuViewBase : DSLLinearLayoutBase() {
...
abstract class DSLToolbarBase : DSLViewGroupBase() {
...
abstract class DSLTvViewBase : DSLViewGroupBase() {
