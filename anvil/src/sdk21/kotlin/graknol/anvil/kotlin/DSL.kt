...
fun Anvil.Renderable.gLSurfaceView(r: DSLGLSurfaceView.() -> Unit) = DSL.gLSurfaceView({ DSLGLSurfaceView().r() })
fun Anvil.Renderable.viewGroup(r: DSLViewGroup.() -> Unit) = DSL.viewGroup({ DSLViewGroup().r() })
fun Anvil.Renderable.checkBox(r: DSLCheckBox.() -> Unit) = DSL.checkBox({ DSLCheckBox().r() })
fun Anvil.Renderable.seekBar(r: DSLSeekBar.() -> Unit) = DSL.seekBar({ DSLSeekBar().r() })
fun Anvil.Renderable.fragmentBreadCrumbs(r: DSLFragmentBreadCrumbs.() -> Unit) = DSL.fragmentBreadCrumbs({ DSLFragmentBreadCrumbs().r() })
fun Anvil.Renderable.digitalClock(r: DSLDigitalClock.() -> Unit) = DSL.digitalClock({ DSLDigitalClock().r() })
fun Anvil.Renderable.imageView(r: DSLImageView.() -> Unit) = DSL.imageView({ DSLImageView().r() })
fun Anvil.Renderable.listView(r: DSLListView.() -> Unit) = DSL.listView({ DSLListView().r() })
fun Anvil.Renderable.tabHost(r: DSLTabHost.() -> Unit) = DSL.tabHost({ DSLTabHost().r() })
fun Anvil.Renderable.webView(r: DSLWebView.() -> Unit) = DSL.webView({ DSLWebView().r() })
fun Anvil.Renderable.compoundButton(r: DSLCompoundButton.() -> Unit) = DSL.compoundButton({ DSLCompoundButton().r() })
fun Anvil.Renderable.gallery(r: DSLGallery.() -> Unit) = DSL.gallery({ DSLGallery().r() })
fun Anvil.Renderable.relativeLayout(r: DSLRelativeLayout.() -> Unit) = DSL.relativeLayout({ DSLRelativeLayout().r() })
fun Anvil.Renderable.radioGroup(r: DSLRadioGroup.() -> Unit) = DSL.radioGroup({ DSLRadioGroup().r() })
fun Anvil.Renderable.space(r: DSLSpace.() -> Unit) = DSL.space({ DSLSpace().r() })
fun Anvil.Renderable.multiAutoCompleteTextView(r: DSLMultiAutoCompleteTextView.() -> Unit) = DSL.multiAutoCompleteTextView({ DSLMultiAutoCompleteTextView().r() })
fun Anvil.Renderable.gestureOverlayView(r: DSLGestureOverlayView.() -> Unit) = DSL.gestureOverlayView({ DSLGestureOverlayView().r() })
fun Anvil.Renderable.horizontalScrollView(r: DSLHorizontalScrollView.() -> Unit) = DSL.horizontalScrollView({ DSLHorizontalScrollView().r() })
fun Anvil.Renderable.chronometer(r: DSLChronometer.() -> Unit) = DSL.chronometer({ DSLChronometer().r() })
fun Anvil.Renderable.linearLayout(r: DSLLinearLayout.() -> Unit) = DSL.linearLayout({ DSLLinearLayout().r() })
fun Anvil.Renderable.mediaController(r: DSLMediaController.() -> Unit) = DSL.mediaController({ DSLMediaController().r() })
fun Anvil.Renderable.checkedTextView(r: DSLCheckedTextView.() -> Unit) = DSL.checkedTextView({ DSLCheckedTextView().r() })
fun Anvil.Renderable.analogClock(r: DSLAnalogClock.() -> Unit) = DSL.analogClock({ DSLAnalogClock().r() })
fun Anvil.Renderable.absListView(r: DSLAbsListView.() -> Unit) = DSL.absListView({ DSLAbsListView().r() })
fun Anvil.Renderable.dialerFilter(r: DSLDialerFilter.() -> Unit) = DSL.dialerFilter({ DSLDialerFilter().r() })
fun Anvil.Renderable.absSeekBar(r: DSLAbsSeekBar.() -> Unit) = DSL.absSeekBar({ DSLAbsSeekBar().r() })
fun Anvil.Renderable.viewStub(r: DSLViewStub.() -> Unit) = DSL.viewStub({ DSLViewStub().r() })
fun Anvil.Renderable.tableLayout(r: DSLTableLayout.() -> Unit) = DSL.tableLayout({ DSLTableLayout().r() })
fun Anvil.Renderable.progressBar(r: DSLProgressBar.() -> Unit) = DSL.progressBar({ DSLProgressBar().r() })
fun Anvil.Renderable.editText(r: DSLEditText.() -> Unit) = DSL.editText({ DSLEditText().r() })
fun Anvil.Renderable.zoomButton(r: DSLZoomButton.() -> Unit) = DSL.zoomButton({ DSLZoomButton().r() })
fun Anvil.Renderable.mediaRouteButton(r: DSLMediaRouteButton.() -> Unit) = DSL.mediaRouteButton({ DSLMediaRouteButton().r() })
fun Anvil.Renderable.tvView(r: DSLTvView.() -> Unit) = DSL.tvView({ DSLTvView().r() })
fun Anvil.Renderable.gridView(r: DSLGridView.() -> Unit) = DSL.gridView({ DSLGridView().r() })
fun Anvil.Renderable.textureView(r: DSLTextureView.() -> Unit) = DSL.textureView({ DSLTextureView().r() })
fun Anvil.Renderable.frameLayout(r: DSLFrameLayout.() -> Unit) = DSL.frameLayout({ DSLFrameLayout().r() })
fun Anvil.Renderable.imageSwitcher(r: DSLImageSwitcher.() -> Unit) = DSL.imageSwitcher({ DSLImageSwitcher().r() })
fun Anvil.Renderable.quickContactBadge(r: DSLQuickContactBadge.() -> Unit) = DSL.quickContactBadge({ DSLQuickContactBadge().r() })
fun Anvil.Renderable.calendarView(r: DSLCalendarView.() -> Unit) = DSL.calendarView({ DSLCalendarView().r() })
fun Anvil.Renderable.videoView(r: DSLVideoView.() -> Unit) = DSL.videoView({ DSLVideoView().r() })
fun Anvil.Renderable.scrollView(r: DSLScrollView.() -> Unit) = DSL.scrollView({ DSLScrollView().r() })
fun Anvil.Renderable.textSwitcher(r: DSLTextSwitcher.() -> Unit) = DSL.textSwitcher({ DSLTextSwitcher().r() })
fun Anvil.Renderable.numberPicker(r: DSLNumberPicker.() -> Unit) = DSL.numberPicker({ DSLNumberPicker().r() })
fun Anvil.Renderable.adapterView(r: DSLAdapterView.() -> Unit) = DSL.adapterView({ DSLAdapterView().r() })
fun Anvil.Renderable.toolbar(r: DSLToolbar.() -> Unit) = DSL.toolbar({ DSLToolbar().r() })
fun Anvil.Renderable.keyboardView(r: DSLKeyboardView.() -> Unit) = DSL.keyboardView({ DSLKeyboardView().r() })
fun Anvil.Renderable.textView(r: DSLTextView.() -> Unit) = DSL.textView({ DSLTextView().r() })
fun Anvil.Renderable.spinner(r: DSLSpinner.() -> Unit) = DSL.spinner({ DSLSpinner().r() })
fun Anvil.Renderable.imageButton(r: DSLImageButton.() -> Unit) = DSL.imageButton({ DSLImageButton().r() })
fun Anvil.Renderable.autoCompleteTextView(r: DSLAutoCompleteTextView.() -> Unit) = DSL.autoCompleteTextView({ DSLAutoCompleteTextView().r() })
fun Anvil.Renderable.actionMenuView(r: DSLActionMenuView.() -> Unit) = DSL.actionMenuView({ DSLActionMenuView().r() })
fun Anvil.Renderable.searchView(r: DSLSearchView.() -> Unit) = DSL.searchView({ DSLSearchView().r() })
fun Anvil.Renderable.timePicker(r: DSLTimePicker.() -> Unit) = DSL.timePicker({ DSLTimePicker().r() })
fun Anvil.Renderable.adapterViewFlipper(r: DSLAdapterViewFlipper.() -> Unit) = DSL.adapterViewFlipper({ DSLAdapterViewFlipper().r() })
fun Anvil.Renderable.viewAnimator(r: DSLViewAnimator.() -> Unit) = DSL.viewAnimator({ DSLViewAnimator().r() })
fun Anvil.Renderable.absSpinner(r: DSLAbsSpinner.() -> Unit) = DSL.absSpinner({ DSLAbsSpinner().r() })
fun Anvil.Renderable.expandableListView(r: DSLExpandableListView.() -> Unit) = DSL.expandableListView({ DSLExpandableListView().r() })
fun Anvil.Renderable.slidingDrawer(r: DSLSlidingDrawer.() -> Unit) = DSL.slidingDrawer({ DSLSlidingDrawer().r() })
fun Anvil.Renderable.toggleButton(r: DSLToggleButton.() -> Unit) = DSL.toggleButton({ DSLToggleButton().r() })
fun Anvil.Renderable.viewSwitcher(r: DSLViewSwitcher.() -> Unit) = DSL.viewSwitcher({ DSLViewSwitcher().r() })
fun Anvil.Renderable.zoomControls(r: DSLZoomControls.() -> Unit) = DSL.zoomControls({ DSLZoomControls().r() })
fun Anvil.Renderable.view(r: DSLView.() -> Unit) = DSL.view({ DSLView().r() })
fun Anvil.Renderable.textClock(r: DSLTextClock.() -> Unit) = DSL.textClock({ DSLTextClock().r() })
fun Anvil.Renderable.tableRow(r: DSLTableRow.() -> Unit) = DSL.tableRow({ DSLTableRow().r() })
fun Anvil.Renderable.tabWidget(r: DSLTabWidget.() -> Unit) = DSL.tabWidget({ DSLTabWidget().r() })
fun Anvil.Renderable.adapterViewAnimator(r: DSLAdapterViewAnimator.() -> Unit) = DSL.adapterViewAnimator({ DSLAdapterViewAnimator().r() })
fun Anvil.Renderable.button(r: DSLButton.() -> Unit) = DSL.button({ DSLButton().r() })
fun Anvil.Renderable.surfaceView(r: DSLSurfaceView.() -> Unit) = DSL.surfaceView({ DSLSurfaceView().r() })
fun Anvil.Renderable.ratingBar(r: DSLRatingBar.() -> Unit) = DSL.ratingBar({ DSLRatingBar().r() })
fun Anvil.Renderable.radioButton(r: DSLRadioButton.() -> Unit) = DSL.radioButton({ DSLRadioButton().r() })
fun Anvil.Renderable.datePicker(r: DSLDatePicker.() -> Unit) = DSL.datePicker({ DSLDatePicker().r() })
fun Anvil.Renderable.twoLineListItem(r: DSLTwoLineListItem.() -> Unit) = DSL.twoLineListItem({ DSLTwoLineListItem().r() })
fun Anvil.Renderable.switchView(r: DSLSwitchView.() -> Unit) = DSL.switchView({ DSLSwitchView().r() })
fun Anvil.Renderable.stackView(r: DSLStackView.() -> Unit) = DSL.stackView({ DSLStackView().r() })
fun Anvil.Renderable.extractEditText(r: DSLExtractEditText.() -> Unit) = DSL.extractEditText({ DSLExtractEditText().r() })
fun Anvil.Renderable.viewFlipper(r: DSLViewFlipper.() -> Unit) = DSL.viewFlipper({ DSLViewFlipper().r() })
fun Anvil.Renderable.absoluteLayout(r: DSLAbsoluteLayout.() -> Unit) = DSL.absoluteLayout({ DSLAbsoluteLayout().r() })
fun Anvil.Renderable.gridLayout(r: DSLGridLayout.() -> Unit) = DSL.gridLayout({ DSLGridLayout().r() })
fun Anvil.Renderable.appWidgetHostView(r: DSLAppWidgetHostView.() -> Unit) = DSL.appWidgetHostView({ DSLAppWidgetHostView().r() })
